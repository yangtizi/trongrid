...
// 获取当前一期 Block
type TNowBlockRsp struct {
	BlockID     string       `json:"blockID"`
	BlockHeader TBlockHeader `json:"block_header"`
	// Transactions []TTransactions `json:"transactions"`
}

type TBlockHeader struct {
	RawData          TRawData `json:"raw_data"`
	WitnessSignature string   `json:"witness_signature"`
}

type TRawData struct {
	Number          int64  `json:"number"`          //: 24902354,
	TxTrieRoot      string `json:"txTrieRoot"`      //: "610a475ae2c9cb27a4ea5f123c0310eb0f2c73370028934291cff8ed20698a33",
	Witness_address string `json:"witness_address"` //: "41f16412b9a17ee9408646e2a21e16478f72ed1e95",
	ParentHash      string `json:"parentHash"`      //: "00000000017bfad18ca0dd12811737d3585af5fe9af908ebf26df6d6568ffb51",
	Version         int    `json:"version"`         //: 23,
	Timestamp       int64  `json:"timestamp"`       //: 1654152273000
}

func GetNowBlock() (rsp TNowBlockRsp, err error) {
