...
type TGetBlockByIDReq struct {
	Value int `json:"value"` // 区块ID
}

type TGetBlockByIDRsp struct {
}

func GetBlockByID(req *TGetBlockByIDReq) (rsp TGetBlockByIDRsp, err error) {
